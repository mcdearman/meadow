...
//!
//! `meadow build --runtime aot` compiles a program all the way to machine code
...
//! stack. `docs/AOT.md` is the design.
//!
...
//! answers words: references are counted as `docs/AOT.md` says, a primitive
...
#[unsafe(export_name = concat!("meadow_aot_", env!("MEADOW_AOT_FINGERPRINT")))]
