...
// by `include!`, between `glade/build.rs` and `silo/build.rs`, which must answer
// alike for the same trees -- the code generator in `glade` names the symbol
// the `meadow-silo` library exports.
//
